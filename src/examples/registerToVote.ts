...
const service: FrameworkService = {
  ...
  pages: [
    ...
    },
    {
      ...
      preRequisiteData: ["dateOfBirthField"],
      elements: [
        new Heading("What is your full name?"),
        new ErrorList("There is a problem"),
        new Form([
          new SubHeading("Enter all your names in full - don't use initials"),
          ({
            name: "firstNameField",
            type: "TextField",
          ...
          new SubHeading("Have you ever changed your name?"),
          ({
    ...
    },
    {
      ...
      preRequisiteData: ["firstNameField"],
...

    {
      ...
      preRequisiteData: ["secondAddressField"],
      elements: [
    ...
    },
    {
      ...
      preRequisiteData: ["openRegisterField"],
      elements: [
    ...
    },
    {
      ...
      preRequisiteData: ["postalVoteField"],
      elements: [
    ...
    },
    {
      ...
      preRequisiteData: ["otherVotersField"],
    ...
    },
    {
      ...
      elements: [
        new Form([
          new Heading("Check your registration details"),
