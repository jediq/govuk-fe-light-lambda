...
- [ ] Rewrite README page
- [x] Override Nunjcuks renderer for pages
- [ ] Select different renderer for clients (GDS vs NI)
- [ ] Logging
- [ ] Google Analytics
...
- [ ] Refactoring context / validator / app relationship
...
[ ] TODO Need to work out which licence to use
